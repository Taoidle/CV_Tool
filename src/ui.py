...
class PicToolsWindow(QWidget):
    ...
    def init_ui(self):
        ...
        self.box_5_button_8.setText('重映射')
        self.box_5_button_8.setAutoRaise(True)
        self.box_5_button_9 = QToolButton()
        self.box_5_button_9.setText('仿射变换')
        self.box_5_button_9.setAutoRaise(True)
        self.box_5_button_10 = QToolButton()
        self.box_5_button_10.setText('DCT变换')
        self.box_5_button_10.setAutoRaise(True)
        ...
        self.v_box_5.addWidget(self.box_5_button_9)
        self.v_box_5.addWidget(self.box_5_button_10)
